...
async function GET(request) {
    ...
    if (code) {
       ...
       puis y attacher les cookies de session. */ const redirectUrl = new URL(next, origin);
        ...
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://owysibkhoyzisvioxypl.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_oSgGQZizDpZZoT6XtC8ikg_Fp1s-hRp"), {
            cookies: {
                getAll () {
                    /* Lire les cookies depuis la requête entrante */ return request.headers.get('cookie')?.split('; ').map((cookie)=>{
               ...
               la réponse HTTP que le navigateur recevra. */ cookiesToSet.forEach(({ name, value, options })=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41e56e74._.js.map