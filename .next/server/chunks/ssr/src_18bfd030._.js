...
async function getSupabaseServer() {
    /* Next.js 15 : cookies() est async — on doit l'attendre.
     cookieStore donne accès aux cookies de la requête HTTP courante. */ const cookieStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cookies"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://owysibkhoyzisvioxypl.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_oSgGQZizDpZZoT6XtC8ikg_Fp1s-hRp"), {
        cookies: {
           ...
           Supabase utilise ça pour trouver le token de session. */ getAll () {
           ...
           Dans ce cas, le middleware prend le relais. */ setAll (cookiesToSet) {
                try {
...
async function AppLayout({ children }) {
    ...
    /* Filet de sécurité : si jamais le middleware n'a pas intercepté
     (cache navigateur agressif, edge case), on bloque ici aussi. */ if (!user) {
...
//# sourceMappingURL=src_18bfd030._.js.map