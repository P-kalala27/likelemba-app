...
function getSupabaseBrowser() {
    ...
    /* Les variables NEXT_PUBLIC_ sont accessibles dans le navigateur.
     ...
     avec un message d'erreur plutôt que silencieusement. */ client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://owysibkhoyzisvioxypl.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_oSgGQZizDpZZoT6XtC8ikg_Fp1s-hRp"));
    return client;
}
...
"[project]/src/components/features/auth/EmailStep.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(EmailStep, "HXCd6C9Neg4Q1PGUj+/gfYgo7XM=");
_c = EmailStep;
var _c;
...
function formatCurrency(amount) {
    let currency = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'CDF';
    if (currency === 'USD') {
        return "$".concat(amount.toFixed(2));
    }
    // Séparateur de milliers = espace (format français)
    return "".concat(amount.toLocaleString('fr-FR'), " CDF");
}
function normalizePhone(input) {
    // Supprime espaces, tirets, parenthèses
    const digits = input.replace(/[\s\-\(\)\.]/g, '');
    if (digits.startsWith('+243') && digits.length === 13) return digits;
    if (digits.startsWith('243') && digits.length === 12) return "+".concat(digits);
    if (digits.startsWith('0') && digits.length === 10) return "+243".concat(digits.slice(1));
    if (digits.length === 9) return "+243".concat(digits);
    return null;
}
...
"[project]/src/components/features/auth/OtpStep.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OtpStep(param) {
    ...
    /* Référence vers chaque input pour gérer le focus programmatiquement */ const inputRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(Array(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH).fill(null));
    /* ── Countdown du renvoi SMS ─────────────────────────────────────────── */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OtpStep.useEffect": ()=>{
            if (countdown <= 0) return;
            const timer = setTimeout({
                "OtpStep.useEffect.timer": ()=>setCountdown({
                        "OtpStep.useEffect.timer": (c)=>c - 1
                    }["OtpStep.useEffect.timer"])
            }["OtpStep.useEffect.timer"], 1000);
            return ({
                "OtpStep.useEffect": ()=>clearTimeout(timer)
            })["OtpStep.useEffect"];
        }
    }["OtpStep.useEffect"], [
        countdown
    ]);
    /* ── Focus automatique sur la première case au montage ───────────────── */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OtpStep.useEffect": ()=>{
    ...
    /* ── Auto-submit dès que les 6 chiffres sont remplis ──────────────────── */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OtpStep.useEffect": ()=>{
            const code = digits.join('');
            if (code.length === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH && !loading) {
                handleSubmit(code);
            }
   ...
   */ function handleDigitChange(index, value) {
        /* Cas paste : value contient plusieurs caractères */ if (value.length > 1) {
            var _inputRefs_current_lastFilledIndex;
            const pasted = value.replace(/\D/g, '').slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH);
            const newDigits = Array(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH).fill('');
            pasted.split('').forEach((digit, i)=>{
                newDigits[i] = digit;
            });
            setDigits(newDigits);
            /* Focus sur la dernière case remplie (ou la dernière case si tout est rempli) */ const lastFilledIndex = Math.min(pasted.length - 1, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH - 1);
            (_inputRefs_current_lastFilledIndex = inputRefs.current[lastFilledIndex]) === null || _inputRefs_current_lastFilledIndex === void 0 ? void 0 : _inputRefs_current_lastFilledIndex.focus();
            return;
        }
        ...
        setDigits(newDigits);
        /* Avancer automatiquement à la case suivante */ if (digit && index < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH - 1) {
            var _inputRefs_current_;
   ...
   */ function handleKeyDown(index, e) {
    ...
    async function handleResend() {
        var _inputRefs_current_;
        setResending(true);
        setDigits(Array(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH).fill(''));
        setCountdown(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].RESEND_COOLDOWN_SEC);
        await onResend();
        setResending(false);
        (_inputRefs_current_ = inputRefs.current[0]) === null || _inputRefs_current_ === void 0 ? void 0 : _inputRefs_current_.focus();
    }
    const code = digits.join('');
    const isFilled = code.length === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "animate-fade-up",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: digits.map((digit, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ref: (el)=>{
               ...
               via le paste, qu'on traite ensuite dans handleDigitChange */ maxLength: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH,
                        value: digit,
                        onChange: (e)=>handleDigitChange(index, e.target.value),
                        onKeyDown: (e)=>handleKeyDown(index, e),
                        disabled: loading || isPending,
                        "aria-label": "Chiffre ".concat(index + 1, " sur ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LIMITS"].OTP_LENGTH),
                        ...
                        style: {
                            ...
                            border: "0.5px solid ".concat(digit ? 'var(--color-border-gold)' : 'var(--color-border)'),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: loading || isPending ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    style: {
                        opacity: 0.7
                    },
...
_s(OtpStep, "ty4E7b/yhSUbIYfdipC1r8qBGYg=");
_c = OtpStep;
/**
 ...
 */ function maskEmail(email) {
    ...
    return "".concat(visible).concat('*'.repeat(Math.max(local.length - 2, 3)), "@").concat(domain);
}
var _c;
...
"[project]/src/app/(auth)/auth/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$auth$2f$EmailStep$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/features/auth/EmailStep.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$auth$2f$OtpStep$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/features/auth/OtpStep.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AuthPage() {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabaseBrowser"])();
    /* État du flux */ const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('email');
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    /* useTransition : marque la navigation comme non-urgente.
     Empêche le freeze de l'UI pendant la redirection vers /dashboard. */ const [isPending, startTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    ...
    /* ── Étape 2 : Vérifier l'OTP ────────────────────────────────────────── */ async function handleVerifyOtp(code) {
        ...
        /* Vérification réussie → rediriger vers la destination */ startTransition(()=>{
         ...
         on le renvoie là-bas. Sinon, dashboard par défaut. */ const redirectTo = (_searchParams_get = searchParams.get('redirect')) !== null && _searchParams_get !== void 0 ? _searchParams_get : '/dashboard';
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: step === 'email' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$auth$2f$EmailStep$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    lineNumber: 151,
                    columnNumber: 11
                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$auth$2f$OtpStep$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    email: email,
...
_s(AuthPage, "9A8L+/0DZerpA0s017rf3wurgfw=", false, function() {
    return [
...
//# sourceMappingURL=src_5acf2ae0._.js.map