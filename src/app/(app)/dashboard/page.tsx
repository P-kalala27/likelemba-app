  ...
  return (
    <main className="flex flex-col flex-1 safe-top">
      ...
      >
        ...
        {/* Avatar — initiales basées sur l'email
            (avant le Sprint 2 où on aura un vrai profil avec nom) */}
        <div
          className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium"
          style={{ background: 'var(--color-purple-dark)', color: 'var(--color-purple)' }}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        {/* Carte de preuve — affiche le numéro connecté pour validation manuelle */}
